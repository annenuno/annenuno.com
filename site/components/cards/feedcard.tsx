  ...
  return (
    <>
      <div className="flex flex-row flex-wrap">
        <motion.div drag>
          <div className="bg-white border-2 border-[#7DB249] rounded w-[266px] h-max">
            ...
            <Image
              ...
              className="border-y-2 border-[#7DB249]"
            />
            <div className="p-3 text-[#7DB249]">annenuno / 07.30</div>
          </div>
        </motion.div>
        <motion.div drag className="relative top-44 right-16">
          <div className="bg-white border-2 border-[#7A88C9] rounded w-[266px] h-max">
            ...
            <Image
              ...
              height={500}
              alt="Picture of the author"
              className="border-y-2 border-[#7A88C9]"
            />
            <div className="p-3 text-[#7A88C9]">annenuno / 07.26</div>
          </div>
        </motion.div>
        <motion.div drag>
          <div className="bg-[#F9FCE4] border-2 border-[#7DB249] rounded w-[266px] h-max">
