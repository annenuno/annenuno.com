    ...
    <>
      <Link href="/annenuno" className="bg-[#FAFAFA]">
        <div className="z-10 flex flex-row gap-5 px-6 py-3 border-2 border-[#366595] rounded-full hover:bg-[#E7F3FF]">
          ...
          <p className="absolute right-[180px] px-2 text-[15px] border-2 border-[#366595] rounded-full">
            UX / UI
          </p>
          <p className="absolute right-[60px] px-2 text-[15px] border-2 border-[#366595] rounded-full">
            Development
          </p>
        </div>
      </Link>
